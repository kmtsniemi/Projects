...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        towns_checkbox->setObjectName(QString::fromUtf8("towns_checkbox"));
        ...
        townnames_checkbox = new QCheckBox(layoutWidget);
        townnames_checkbox->setObjectName(QString::fromUtf8("townnames_checkbox"));
        townnames_checkbox->setChecked(true);

        horizontalLayout_7->addWidget(townnames_checkbox);


        verticalLayout_2->addLayout(horizontalLayout_7);

        vassals_checkbox = new QCheckBox(layoutWidget);
        vassals_checkbox->setObjectName(QString::fromUtf8("vassals_checkbox"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        towns_checkbox->setText(QCoreApplication::translate("MainWindow", "Towns", nullptr));
        townnames_checkbox->setText(QCoreApplication::translate("MainWindow", "Town names", nullptr));
        vassals_checkbox->setText(QCoreApplication::translate("MainWindow", "Vassalships", nullptr));
        roads_checkbox->setText(QCoreApplication::translate("MainWindow", "Roads", nullptr));
